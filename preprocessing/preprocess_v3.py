...
def process_image(image_path, output_path):
    ...
    sharpened_image = cv2.filter2D(centered_image, -1, kernel)
    if cv2.imwrite(output_path, sharpened_image):
...
process_directory("../dataset/raw/Train_Alphabet", "../dataset/processed/v3/training")
process_directory("../dataset/raw/Test_Alphabet", "../dataset/processed/v3/validation")